...
(define framework:color-schemes
  `(#hash((name . "Automata-Theme-Light")
          (white-on-black-base? . #t)
          (colors
           .
           ((framework:basic-canvas-background                 ,light )
            (framework:default-text-color                      ,too-dark)
            ...
            (framework:syntax-color:scheme:symbol              ,too-dark)
